...
public class JCATester {
	...
	public static void main(String[] args) throws NoSuchAlgorithmException, InvalidKeyException, SignatureException {
		...
		System.out.println("Search for QTESLAProvider in Security.");
	   try {
	        Provider p[] = Security.getProviders();
	        for (int i = 0; i < p.length; i++) {
	   ...
	   // Send se sigstr from Alice to Bob
	   System.out.println("Send message from Michael to Anna");
	   System.out.println("");
	   ...
	   boolean is_correct = pub_siggi.verify(signatureBytes);   
	   if(is_correct) {
