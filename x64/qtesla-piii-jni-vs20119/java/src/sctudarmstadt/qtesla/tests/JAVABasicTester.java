...
import sctudarmstadt.qtesla.java.*;
...
public class JAVABasicTester {
	...
	public static void testGenerateKeyPairSigningVerifyingPIII (int runs, int signsperrun)
		...
		*/
        ...
        String messstring = "Hallo Anna, hoffe dein Paper wird super.";
        messageInput[0] = messstring.getBytes();
		...
		{	        
	        for (int round = 0; round < timeOfTest; round++) {           
	            ...
	            for (int signnum = 0; signnum < signsperrun; signnum++) {
	                ...
	                String s = new String(messageInput[round], StandardCharsets.UTF_8);
